        ...
        <div class="card col-lg-12 mb-3">
            ...
            <form class="row g-3" action="" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="card-body text-dark">
                            <p class="card-title"><strong>*jumlah dana*</strong></p>
                        </div>
                    </div>
                    ...
                    <div class="col-4">
                        <div class="card-body text-dark">
                            <div class="form-group">
                                ...
                                <x-basic.input type="text" name="pemilikRekeningName" :error="$errors->first('pemilikRekeningName')" placeholder="masukkan nama pemilik rekening anda..." />
                            </div>
                        ...
                        <div class="card-body text-dark">
                            <div class="form-group">
                                ...
                                <x-basic.input type="text" name="nomorRekening" :error="$errors->first('nomorRekening')" placeholder="masukkan nomor rekening anda..." />
                            </div>
                        </div>
                        ...
                        <div class="card-body text-dark">
                            <div class="form-group">
                                ...
                                <x-basic.input type="text" name="jumlahSaldo" :error="$errors->first('jumlahSaldo')" placeholder="masukkan jumlah saldo...." />
                            </div>
                        </div>
                    </div>
